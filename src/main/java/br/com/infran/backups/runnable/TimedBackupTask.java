package br.com.infran.backups.runnable;

import br.com.infran.backups.compressor.ZipCompressor;
import br.com.infran.backups.service.BackupService;
...
public class TimedBackupTask extends BukkitRunnable {
    ...
    public void run() {
        ...
        try (
            ...
            log.warning("Criando backup! O servidor pode ficar um pouco instável...");
            ...
            log.info(String.format("Backup foi concluído! Time decorrido: %s seconds!", ((System.currentTimeMillis() - start) / 1000)));
